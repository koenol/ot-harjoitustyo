...
class UI:
    ...
    def _start(self):
        ...
        play_x = (self.current_view.get_width() - 100) // 2
        play_y = (self.current_view.get_height()) // 2
        ...
        banner_text_rect.center = (self.current_view.get_width() //2 + 100, self.current_view.get_height() //2 - 150)
